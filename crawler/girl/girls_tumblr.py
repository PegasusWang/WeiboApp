...
class ThegirlnotnakedSpider(Spider):
    def get_img(self, url='http://thegirlnotnaked.tumblr.com/'):
        img_list = get_media_url_list(url)
        img_list = [i.replace('500', '1280') for i in img_list if 'media.tumblr' in i]
        return set([i for i in img_list if 'avatar' not in i])


class SexyInStockingsSpider(Spider):
    def get_img(self, url='http://sexy-in-stockings.tumblr.com/'):
        img_list = get_media_url_list(url)
        img_list = [i.replace('250', '1280') for i in img_list if 'media.tumblr' in i]
        return set([i for i in img_list if 'avatar' not in i])
...
class ABeautifulGSpider(Spider):
    def get_img(self, url='http://a-beautiful-g.tumblr.com/'):
        img_list = get_media_url_list(url)
        img_list = [i.replace('500', '1280') for i in img_list if 'media.tumblr' in i]
        return set([i for i in img_list if 'avatar' not in i])


class TrivistapaSpider(Spider):
    def get_img(self, url='http://trivistapa.tumblr.com'):
        img_list = get_media_url_list(url)
        img_list = [i.replace('500', '1280') for i in img_list if 'media.tumblr' in i]
        return set([i for i in img_list if 'avatar' not in i])
