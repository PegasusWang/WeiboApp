...
class Upload(object):
    def __init__(self, **kwargs):
        ...
        self.map_method = {
            'upload_chinabeauties': self.upload_chinabeauties,
        }
    ...
    def upload_chinabeauties(self, **kwargs):
        beg, end = 1, 680
        for i in range(beg, end+1):
            time.sleep(3)
            url = 'http://chinabeauties.tumblr.com/page/%s' % i
            print url
            leancloud_upload = self._upload
            spider = ChinabeautiesSpider()
...
dict_list = [
    dict(upload_type='chinabeauties', class_name='Chinabeauties'),
]
